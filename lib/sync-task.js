...
const TASK_NOT_STARTED_STATUS = 'http://mu.semte.ch/services/mandatendatabank-consumer/sync-task-statuses/not-started';
const TASK_ONGOING_STATUS = 'http://mu.semte.ch/services/mandatendatabank-consumer/sync-task-statuses/ongoing';
const TASK_SUCCESS_STATUS = 'http://mu.semte.ch/services/mandatendatabank-consumer/sync-task-statuses/success';
const TASK_FAILED_STATUS = 'http://mu.semte.ch/services/mandatendatabank-consumer/sync-task-statuses/failed';
...
async function scheduleSyncTask() {
  ...
  if (result.results.bindings.length) {
    ...
    const uuid = mu.uuid();
    const uri = `http://mu.semte.ch/services/mandatendatabank-consumer/sync-tasks/${uuid}`;
    await update(`
      PREFIX mu: <http://mu.semte.ch/vocabularies/core/>
      PREFIX ext: <http://mu.semte.ch/vocabularies/ext/>
      PREFIX dct: <http://purl.org/dc/terms/>
